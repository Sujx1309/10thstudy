...
class BlackTurmApp {
    ...
    showSection(sectionId) {
        // Only hide the main content sections, not the navigation
        this.elements.homeSection.addClass('d-none');
        ...
        // Always ensure bottom navigation is visible
...
$(document).ready(() => new BlackTurmApp());